...
-- SERVEROUTPUT을..ON시키기.. 환경변수 바꾸는것처럼
SET SERVEROUTPUT ON;
--==>> 작업이 완료되었습니다.(0.XXX초)
...
ACCEPT N1 PROMPT '첫 번재 정수를 입력하세요';
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('입력받은 금액 총액 : NUM1');
    DBMS_OUTPUT.PUT_LINE('오백원' || || ', 백원' || || ',
END

...
--○ SCOTT.TBL_INSA 테이블의 여러 명 데이터 여러 개를 변수에 저장
--   (반복문 활용 출력)
DECLARE
...
--프로시저 생성
--프로시저명 : PRC_SUNGJUK_INSERT(학번, 이름, 국어점수, 영어점수, 수학점수, 총점, 평균, 등급)
-- 필수변수(매개변수)
...
BEGIN
    ...
    UPDATE TBL_STUDENTS
    SET ID=V_ID, NAME=V_NAME, TEL=V_TEL, ADDR=V_ADDR
